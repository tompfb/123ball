...
<head>
    ...
    <meta property="og:url" content="https://xn--123-7ml3c5b.com/view/<?php echo $encode ?>" />
    <meta property="og:site_name" content="เว็บพนันบอล" />

    <meta property="twitter:url" content="https://xn--123-7ml3c5b.com/view/<?php echo $encode ?>">
    ...
    <link rel="alternate" href="https://xn--123-7ml3c5b.com/<?php echo $encode ?>" hreflang="th-TH" />
    <link rel="canonical" href="https://xn--123-7ml3c5b.com/<?php echo $encode ?>" />
    ...
    <script type="application/ld+json">
        {
            ...
            "mainEntityOfPage": {
                "@type": "WebPage",
                "@id": "https://xn--123-7ml3c5b.com/view/<?php echo $encode ?>"
            },
            "headline": "<?php echo $topic_name  ?>",
            "image": [
                "https://xn--123-7ml3c5b.com/backend/uploads/article-img/<?php echo $image_banner  ?>"
            ],
            ...
            "author": {
                "@type": "Person",
                "name": "เว็บพนันบอล",
                "url": "https://xn--123-7ml3c5b.com/view/<?php echo $encode ?>"
            },
            "publisher": {
                "@type": "Organization",
                "name": "เว็บพนันบอล",
...
<body>
    ...
    <article class="view-container  " style="overflow-x: hidden;">
        <section class="all_article container" style="background-color: #000000;">
            <br>
            <div class="container">
                <h1 class="heading-text my-2">
                    <?php echo $topic_name  ?>
                </h1>
                ...
                <div class=" text-center py-3">
                    <aside class="site">
                        ...
                        <div class="my-2 socail">
                            <a href="http://www.facebook.com/sharer.php?u=https://xn--123-7ml3c5b.com/view/<?php echo $encode ?>" target="_blank" class="share-facebook"><i class="fab fa-facebook-f"></i>แชร์</a>
                            <a href="http://twitter.com/share?text=<?php echo $topic_name  ?> &url=https://xn--123-7ml3c5b.com/view/<?php echo $encode ?> &hashtags=<?php while ($rs = mysqli_fetch_array($chacks_query)) { ?><?php echo $rs['tag_url']; ?>,<?php } ?>" target="_blank" class="share-twitter"><i class="fab fa-twitter"></i>ทวีต</a>
                            <a href="https://social-plugins.line.me/lineit/share?url=https://xn--123-7ml3c5b.com/view/<?php echo $encode ?>" target="_blank" class="share-line"><i class="fab fa-line"></i>แชร์</a>
                        </div>
                        <div class="potsnew">
